...
export default function Missao() {
  ...
  return (
    ...
    <div className="bg-[#F5EAE8] relative mx-auto w-full min-h-screen flex flex-col items-center">
      ...
      <div className="relative w-full md:w-[95%] h-auto mt-20 md:h-[600px] p-4 md:p-0 mb-20">
        ...
        <p className="w-full bg-black bg-opacity-30 md:bg-opacity-10 text-white text-center py-6 font-montserrat text-[18px] md:text-[24px] font-medium leading-[27px] md:leading-[36px] mt-4 md:absolute md:bottom-0 md:mt-0 p-5 h-86 md:h-60">
