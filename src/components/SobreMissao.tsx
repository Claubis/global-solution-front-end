...
export default function SobreMissao() {
  return (
    <div className="flex flex-col w-full bg-white p-6 md:p-8 justify-end items-center">
      <div className="w-full flex justify-center mb-8">
        <h1 className="text-[#007871] font-montserrat text-6xl md:text-8xl font-extrabold">
          apoie nossa missão
        </h1>
      </div>

      <div className="w-full flex justify-center mb-4 p-0">
        <h2 className="text-black font-montserrat text-2xl font-extralight md:text-center">
          Para tornar este visionário aplicativo uma realidade, precisamos do seu apoio.
        </h2>
      </div>

      <div className="flex flex-col w-full bg-white md:p-8 justify-end gap-10  md:items-center mt-10 md:mt-0">
        <h2 className="text-black font-montserrat text-5xl font-extrabold leading-[50px] md:text-center">
          Contribua para o Nosso <br /> Financiamento Coletivo
        </h2>

        <p className='text-black font-montserrat font-extralight text-[20px] leading-[40px] md:text-center'>
      ...
      <div className="flex flex-col md:w-[70%] bg-[#B9E2E0] p-8 gap-10 rounded-xl items-center mt-20 md:mt-0">
        <h3 className="text-black font-montserrat text-4xl font-extrabold leading-[100%]">
          Como Contribuir
        </h3>
      ...
      <div className="flex flex-col w-full bg-white md:p-8 gap-10 mt-20 items-center">
        <h4 className="text-black font-montserrat text-4xl font-extrabold leading-[120%] md:text-center">
          Recompensas para Nossos Apoiadores
        </h4>

        <p className='text-md md:text-center font-montserrat font-extralight'>
      ...
      <div className="flex flex-col p-5 bg-[#F1A027] w-full md:max-w-[30%] text-center justify-center items-center mt-10 md:mt-5 mb-20 md:mb-0">
