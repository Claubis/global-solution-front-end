...
export default function ModalDeleteCount() {
    return(
	...
	<p className="flex-1 dark:text-gray-600">Entendemos que pode haver motivos para encerrar sua conta. Se decidir que não deseja mais usar nosso serviço, você pode deletar sua conta aqui. Lembre-se de que esta ação é irreversível e resultará na perda de todos os seus dados armazenados.</p>
